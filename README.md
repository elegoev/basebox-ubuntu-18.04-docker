...
Vagrant Box with Ubuntu 18.04 and Docker
...
- [elegoev/ubuntu-18.04-docker](https://app.vagrantup.com/elegoev/boxes/ubuntu-18.04-docker)
...
### Vagrantfile
    ...
    Vagrant.configure("2") do |config|
      ...
      $basebox_name="ubuntu-18.04-docker-test"
